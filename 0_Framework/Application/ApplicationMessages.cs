namespace _0_Framework.Application
{
    public class ApplicationMessages
    {
        ...
        public static string MisMatchPassword = "رمز عبور و تکرار آن مطابقت ندارد";
        public static string passwordOrUserMisMatch = "نام کاربری و یا رمز عبور صحیح نمی باشد";
